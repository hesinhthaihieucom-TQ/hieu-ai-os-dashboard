    ...
    container.innerHTML = `
      <div class="page-head">
        ...
        <p>${alreadyPaid
          ...
          : 'Mở khoá TRỌN ĐỜI Chấm Điểm Nghiệp Tiền, Hạt Giống Phước - Nghiệp, Mục Tiêu & Cam Kết, Tổng Kết Tuần/Tháng, Quản Lý Nợ — chỉ 1 lần, dùng mãi mãi, không phải trả lại theo tháng.'}</p>
      </div>
      ${alreadyPaid ? `
