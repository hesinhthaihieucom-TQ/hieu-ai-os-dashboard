...
const GLOSSARY = {
  tai_san: { term:'Tài sản', explain:'Thứ mang lại TIỀN cho bạn theo thời gian — tiết kiệm, vàng, cổ phiếu, bất động sản cho thuê... Tài sản càng nhiều, dòng tiền chảy VÀO tương lai của bạn càng lớn.' },
  tieu_san: { term:'Tiêu sản', explain:'Thứ LẤY TIỀN của bạn theo thời gian — mất giá trị dần, tốn phí duy trì hàng tháng (xe hơi, đồ điện tử, nợ thẻ tín dụng chưa trả...). Không xấu, nhưng cần ý thức rõ nó đang lấy tiền chứ không sinh tiền.' },
  ...
  ngoi_nha: { term:'5 Trụ Cột Năng Lượng Bản Thể', explain:'Mọi dòng tiền đi qua bạn đều ảnh hưởng tới 5 trụ cột đời sống: (1) Thân Tâm Bản Thể, (2) Cội Nguồn Sinh Thành, (3) Bạn Đời & Mối Quan Hệ Thân Mật, (4) Giá Trị Cống Hiến & Tài Chính Tâm Thức, (5) Tiến Trình Thuận Pháp & Nhân Quả. Gắn mục tiêu vào 1 trụ giúp mục tiêu có ý nghĩa cảm xúc thật, không chỉ là con số khô khan — tâm thức khó "sập nguồn" trước 1 mục tiêu có ý nghĩa rõ ràng.' },
  ...
  tang_thuc: { term:'Tàng Thức là gì?', explain:'Tầng gốc rễ sâu nhất — nơi cất giữ những niềm tin cũ về tiền hình thành từ ký ức, tuổi thơ, lời người thân từng nói. Những niềm tin này âm thầm nuôi các phản ứng cảm xúc lặp lại ở Tâm Thức (vd các Nút Chặn Dòng Tiền), rồi chi phối Tiềm Thức (thói quen hành xử với tiền không cần suy nghĩ), và cuối cùng hiện ra thành kết quả thật ở Ý Thức (số dư, nợ, tài sản — đời sống vật chất). Nhìn thấy niềm tin gốc ở Tàng Thức chính là nơi bắt đầu chữa lành, thay vì chỉ sửa triệu chứng ở bề mặt.' },
};
