// Hướng dẫn kiểu "spotlight" trỏ vị trí từng phần tử NGAY TRONG TRANG (2026-08-31, làm giống
// nhan-hieu/js/page-tour.js và tro-ly-crm/js/page-tour.js cho Sổ Dòng Tiền Tâm Thức) — CÙNG kỹ
// thuật box-shadow spotlight với onboarding-tour.js/feature-tour.js (box-shadow 0 0 0 9999px phủ mờ
// toàn màn hình, trừ đúng khung quanh phần tử đang trỏ tới), nhưng viết thành 1 ENGINE DÙNG CHUNG
// cho MỌI trang (không chỉ sidebar) — mỗi module tự định nghĩa mảng bước {selector, title, text}
// rồi gọi window.startPageTour(steps) khi bấm nút "❓ Hướng dẫn" của trang đó. KHÔNG dùng chung file
// với onboarding-tour.js/feature-tour.js (deliberately copy kỹ thuật chứ không import, giống quy
// ước 2 file kia đã có sẵn) và KHÔNG dùng chung file với nhan-hieu/tro-ly-crm (khác app).
(function(){
