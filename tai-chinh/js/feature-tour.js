(function(){
// Popup thông báo tính năng mới giữa màn hình + tuỳ chọn hướng dẫn từng bước — COPY nguyên vẹn từ
// nhan-hieu/js/feature-tour.js sang tai-chinh/ (2026-08-23, áp dụng quy tắc bên Xây Nhân Hiệu cho Sổ
// Dòng Tiền Tâm Thức), vì cơ chế trỏ sáng .sidebar-item[data-key] dùng chung cấu trúc sidebar giữa 2
// app. KHÔNG dùng chung bảng feature_announcements của nhan-hieu — tai-chinh có bảng riêng
// tc_feature_announcements (khác tính năng, khác nội dung), xem app-shell.js. Sửa file này ở đâu thì
// nhớ cân nhắc sửa luôn bên kia nếu là lỗi chung, nhưng đừng rename hàm để tránh phải sửa cả 2 nơi.

// ann: 1 dòng từ bảng tc_feature_announcements ({id, title, body, steps}). onDone: gọi khi popup
// đóng (bất kể bấm "Đã hiểu"/"Bỏ qua" hay đi hết các bước) — dùng để lưu tc_last_seen_announcement_id.
