// Hướng dẫn kiểu "spotlight" trỏ vị trí từng phần tử ngay trong trang (2026-08-30, chị Quỳnh chốt:
// "hướng dẫn kiểu popup trỏ vị trí từng cái trong mục đó ... kiểu hướng dẫn như web xây nhân hiệu
// á") — CÙNG kỹ thuật box-shadow spotlight với nhan-hieu/js/onboarding-tour.js (box-shadow
// 0 0 0 9999px phủ mờ toàn màn hình, trừ đúng khung quanh phần tử đang trỏ tới), nhưng viết thành 1
// ENGINE DÙNG CHUNG cho MỌI trang (không riêng sidebar) — mỗi module tự định nghĩa mảng bước
// {selector, title, text} rồi gọi window.startPageTour(steps) khi bấm nút "Hướng dẫn" của trang đó.
// KHÔNG dùng chung file với nhan-hieu (khác app, deliberately copy kỹ thuật chứ không import).
(function(){
