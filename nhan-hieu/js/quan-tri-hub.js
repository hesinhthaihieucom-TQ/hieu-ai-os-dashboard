...
function render(container, ctx){
  ...
  function draw(){
    ...
    const subModuleKey = state.tab === 'thanhvien' ? 'quan-tri' : state.tab === 'taichinh' ? 'quan-tri-taichinh' : state.tab === 'thongbao' ? 'quan-tri-thongbao' : state.tab === 'danhgia' ? 'quan-tri-danhgia' : state.tab === 'marketing' ? 'quan-tri-marketing' : 'quan-tri-kho';
