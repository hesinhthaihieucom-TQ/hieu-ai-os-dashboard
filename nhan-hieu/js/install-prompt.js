...
function maybeShowInstallPrompt(){
  ...
  overlay.innerHTML = `
    <div style="max-width:360px;width:100%;background:#fff;border-radius:16px;padding:26px 24px;text-align:center;box-shadow:0 20px 50px rgba(0,0,0,.3);">
      ...
      ${ios ? `
        <div style="font-size:15px;color:#5B5F55;line-height:1.7;margin-bottom:18px;">Mở nhanh như 1 app riêng, không cần mở trình duyệt trước:<br>
      ...
      ` : `
        <div style="font-size:15px;color:#5B5F55;line-height:1.7;margin-bottom:18px;">Mở nhanh như 1 app riêng, không cần mở trình duyệt trước — cài mất vài giây.</div>
