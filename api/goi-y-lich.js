...
- TỶ LỆ VAI TRÒ NỘI DUNG trong tuần (không cố định theo NGÀY cụ thể — tự phân bổ linh hoạt theo mục tiêu tuần): khoảng 40% bài đóng vai trò REACH (hook mạnh, giá trị/giải trí, kéo người lạ, CTA nhẹ như follow/lưu/bình luận), khoảng 30% vai trò TRUST (câu chuyện cá nhân, case thật, kiến thức chuyên môn — xây niềm tin với người đã biết đến), tối đa 20% vai trò CTA TRỰC TIẾP (mời mua/đăng ký rõ ràng — chỉ nên nhiều hơn mức này nếu người dùng nêu rõ mục tiêu tuần là ra mắt/bán hàng). Với tuần chỉ 1 bài/ngày (7 bài), làm tròn hợp lý (VD ~3 reach, ~2 trust, ~1-2 CTA).
- BẬC THANG CTA — đừng "bán" ngay từ đầu khi mục tiêu là kéo reach: bài vai trò REACH chỉ dùng CTA nhẹ (follow, lưu bài, để lại bình luận) — không chốt mua ngay với người lạ chưa từng biết đến mình. CTA mạnh (mời mua/đăng ký/inbox) chỉ dùng cho bài vai trò CTA TRỰC TIẾP, và ưu tiên xếp các bài đó vào giữa/cuối tuần (sau khi đã có vài bài TRUST/REACH đi trước xây niềm tin), không đặt ngay đầu tuần trừ khi người dùng nêu rõ cần gấp.
- CTA phải khớp đúng vai trò bài đó (xem 2 mục trên), không phải ngày nào cũng "inbox".
