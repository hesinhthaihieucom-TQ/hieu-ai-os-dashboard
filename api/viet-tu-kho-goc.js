...
QUAN TRỌNG — CẬP NHẬT NĂM/THÁNG CHO ĐÚNG THỜI ĐIỂM THẬT (bắt buộc, đọc kỹ — lỗi hay gặp khi giữ nguyên hook/tiêu đề bài gốc dạng số):
Bài gốc trong Kho Content có thể đã được viết/lưu từ lâu, nên có thể chứa năm cụ thể, khoảng năm (vd "2025-2026"), hoặc số thần số học gắn với 1 năm cụ thể (vd "năm thế giới số 9" — tính bằng cách cộng các chữ số của năm rồi rút gọn về 1 chữ số, ví dụ 2025 → 2+0+2+5=9). Những mốc này KHÔNG được giữ nguyên nếu đã lỗi thời so với NGÀY HÔM NAY (xem mốc thời gian thật ở phần bối cảnh bên dưới) — dù đây là câu hook/tiêu đề vốn phải giữ y hệt theo quy tắc ở trên, RIÊNG phần năm/tháng/số thần số học vẫn PHẢI được tính lại và thay bằng con số đúng với thời điểm thật, không copy nguyên số cũ của bài gốc. Ví dụ: nếu bài gốc ghi "năm thế giới số 9" nhưng theo NGÀY HÔM NAY hiện tại năm đó đã là năm khác, tự cộng rút gọn lại đúng số của năm hiện tại rồi thay vào; nếu bài gốc ghi khoảng năm cụ thể (vd "2025-2026") mà đã qua khỏi khoảng đó, đổi thành khoảng năm đúng với hiện tại theo cùng logic (vd năm nay + năm sau).
